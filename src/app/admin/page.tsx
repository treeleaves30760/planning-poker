...
export default function AdminPage() {
	...
	const ScoreInput = ({
		...
		<input
			...
			value={value}
			onChange={(e) =>
				handleScoreChange(dimension, level, parseInt(e.target.value) || 0)
			}
								...
								<tr className="border-b">
									...
									<td className="text-center">
										<ScoreInput
											...
											level="low"
											value={scoreConfig.uncertainty.low}
										/>
									</td>
									<td className="text-center">
										<ScoreInput
											dimension="uncertainty"
											level="mid"
											value={scoreConfig.uncertainty.mid}
										/>
									</td>
									<td className="text-center">
										<ScoreInput
											dimension="uncertainty"
											level="high"
											value={scoreConfig.uncertainty.high}
										/>
									</td>
								</tr>
								<tr className="border-b">
									...
									<td className="text-center">
										<ScoreInput
											...
											level="low"
											value={scoreConfig.complexity.low}
										/>
									</td>
									<td className="text-center">
										<ScoreInput
											dimension="complexity"
											level="mid"
											value={scoreConfig.complexity.mid}
										/>
									</td>
									<td className="text-center">
										<ScoreInput
											dimension="complexity"
											level="high"
											value={scoreConfig.complexity.high}
										/>
									</td>
								</tr>
								<tr>
